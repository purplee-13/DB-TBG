<nav class="bg-white shadow-md px-6 py-3 flex items-center justify-between relative">
    ...
    <ul class="flex gap-6 text-gray-700 font-medium">
        <li>
            <a href="{{ url('/dashboard') }}"
                class="{{ request()->is('dashboard') ? 'text-[#022CB8] font-semibold border-b-2 border-[#022CB8] pb-1' : 'hover:text-blue-600 hover:border-b-2 hover:border-blue-600 pb-1' }}">
                Dashboard
            </a>
        </li>
        <li>
            <a href="{{ url('/datasite') }}"
                class="{{ request()->is('datasite') ? 'text-[#022CB8] font-semibold border-b-2 border-[#022CB8] pb-1' : 'hover:text-blue-600 hover:border-b-2 hover:border-blue-600 pb-1' }}">
                Data Site
            </a>
        </li>
        <li>
            <a href="{{ url('/update-maintenance') }}"
                class="{{ request()->is('update-maintenance') ? 'text-[#022CB8] font-semibold border-b-2 border-[#022CB8] pb-1' : 'hover:text-blue-600 hover:border-b-2 hover:border-blue-600 pb-1' }}">
                Update Maintenance
            </a>
        </li>
    </ul>
